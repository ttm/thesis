...
These facts make expose how counter-intuitive are the stability we report in this thesis.
...
\item Measurements derived from TF-IDF (term frequency-inverse document frequency),
	...
	\item This research included many exploratory endeavors which were included in Appendix~\ref{ap:more}.
		They were important in enhancing my understanding of human social structures,
		have documentations and software, and might benefit from more scientific presentations.

\item We realized some multiscale analyzes by going through networks derived by tenths to thousands of messages.
