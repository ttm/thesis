...
The data used here were obtained from Facebook, Twitter, IRC, Email and the
...
Further information is available in the Appendix~\ref{ap:losd} and in an article~\cite{olsd}.
...
\begin{itemize}
	\item Wordnet: a lexical database for the English language released in a BSD style license. It groups synonyms into synsets, provides a number of relations among the synsets and provides definitions and use examples.
	\item Synset: defined by Wordnet as a set of one or more synonyms that are (somewhat) interchangeable without changing the true value of the proposition in which they occur.
