...
In~\cite{aa} we present a new self-regulating methodology for coordinating distributed team work called Algorithmic Autoregulation (AA),
...
While AA was important for some documents presented in this thesis~\cite{aa,losd},
...
the article invoked disrupting discussions in email lists and private messaging, specially at the Metareciclagem email list.
...
specially Ricardo Poppi, Arlindo Cavalcanti Queiroz, José Ivan Mayer de Aquino and Luciano Santa Brígida.
...
and the other was an online presentation~\cite{antphy2} on the Conference on Complex Systems CS-DC'15
...
and learning algorithms, specially about the power semi-supervised algorithms.
