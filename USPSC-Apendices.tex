...
sound of the grooves in the cranium.
...
and in closing the International Conference in Critical Theory in Rome (online participation).
...
to Social Network Analysis and the endeavors for collection and diffusion of information~\cite{arsSF,arsND}.
One interesting instance is the publication of the text ``Cognitive clouds and the unification of humanity''
by the Cyberium collective and the Nós Digitais cultural pole.
Some pages are not online anymore, such as the ones referred to in Section~\ref{sec:govArt},
mainly because the services were withdrawn.
% pagina aa client?
