...
For each POS tag, we consider the minimum number of networks for which there has to be such
significant incidence of the synset.
This number of networks was cho
\begin{itemize}
